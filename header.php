...
<div class="wrapper">
        <h1 id="title">NotaBird</h1>
        <h2 id="subtitle"><span class="auto-type"></span></h2>
    ...
    <nav id="navbar">
        ...
        if(!isset($_SESSION["userId"])){
            ...
            echo "<li><a href='followers.php'>FOLLOWED</a></li>";
            echo "<li><a href='profile.php?user=$nick'>PROFILE</a></li>";
            echo "<li><a href='include/logout.inc.php'>LOGOUT</a></li>";
            echo "<li style='float:right'><a id='user' href='profile.php?user=$nick'>$nick</a></li>";
        }
        ?>
        </ul>
    </nav>
